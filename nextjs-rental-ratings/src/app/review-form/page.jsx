...
export default function ReviewForm() {
    ...
    useEffect(() => {
        const getReview = async () => {
            const res = await fetch(
                ...
                }/data/getReview?reviewID=${searchParams.get('id')}`
            )
    ...
    const handleSubmit = (e) => {
        ...
        const sendReview = async () => {
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_API_SERVER}/data/leaveReview`,
                {
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        isOrganization:
                            e.target.is_organization.value === 'on' ? false : true,
        ...
        <main>
            {searchParams.get('id') === '-1' ||
                ...
                <section>
                    ...
                    <div id='error'>{error.error && error.message}</div>
                    ...
                    <form id='review-form' onSubmit={(e) => handleSubmit(e)}>
                        <section id='property-review'>
                            ...
                            <div id='address-container'>
                                ...
                                <GooglePlacesAutocomplete
                                    ...
                                    debounce={1500}
                                    selectProps={{
                                        defaultInputValue: review?.address,
                                        value: address,
                                        onChange: setAddress,
                                    }}
                                />
                            ...
                            <div id='property-rating-container'>
                                ...
                                <input
                                    ...
                                    max={5}
                                    min={1}
                                    defaultValue={review?.propertyRating}
                                />
                                /5
                            </div>
                            ...
                            <div id='property-comments-container'>
                                ...
                                <textarea
                                    ...
                                    defaultValue={review?.propertyComments}
                                />
                            </div>
                        </section>
                        ...
                        <section id='landlord-review'>
                            ...
                            <div id='landlord-organization'>
                                ...
                                <input
                                    ...
                                    defaultValue={review?.isOrganization}
                                />
                            </div>
                            ...
                            <div id='landlord-rating-container'>
                                ...
                                <input
                                    ...
                                    max={5}
                                    min={1}
                                    defaultValue={review?.landlordRating}
                                />
                                /5
                            </div>
                            ...
                            <div id='landlord-comments-container'>
                                ...
                                <textarea
                                    name='landlord_comments'
                                    defaultValue={review?.landlordComments}
                                />
                            </div>
                        </section>
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault
                                router.replace(`/userReviews?user=${user}`)
                            }}
                        >
                ...
                <section>
                    ...
                    <div id='view-rating'>
                        <label>Rating</label>
                        <input readOnly value={review?.propertyRating} />
                        /5
                    </div>
                    ...
                    <div id='view-landord-rating'>
                        <label>Rating</label>
                        <input readOnly value={review?.landlordRating} />
                        /5
                    </div>
